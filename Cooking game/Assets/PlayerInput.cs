...
public partial class @PlayerInput: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""id"": ""cda4ed56-8a6d-4e8d-9fd0-26b9bab9da94"",
            ""actions"": [
                {
                    ""name"": ""Move"",
                    ""type"": ""Value"",
                    ""id"": ""5e2c4321-e2c6-44d1-9205-e997861df717"",
                ...
                },
                {
                    ""name"": ""Interact"",
                    ""type"": ""Button"",
                    ""id"": ""4458b86f-c7a8-4efd-9bbf-dd7a9a5775cf"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
            ...
            ""bindings"": [
                {
                    ""name"": ""2D Vector"",
                    ""id"": ""70a12952-45ea-4875-b2aa-5f56844bc6b8"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""4fa8bebb-5159-4b97-a809-dc3d7a36f093"",
                    ""path"": ""<Keyboard>/w"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""b05eb585-b361-47cc-bc85-a135e7661539"",
                    ""path"": ""<Keyboard>/s"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""f93bc10f-e9e1-4edf-9a44-db8942d63127"",
                    ""path"": ""<Keyboard>/a"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""e70d82fd-1784-4f40-9b22-66803edee79f"",
                    ""path"": ""<Keyboard>/d"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""904352aa-c7aa-420f-aaf5-48445b302437"",
                    ""path"": ""<Keyboard>/e"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ~@PlayerInput()
    {
        UnityEngine.Debug.Assert(!m_PlayerInputAction.enabled, "This will cause a leak and performance issues, PlayerInput.PlayerInputAction.Disable() has not been called.");
    }
    ...
    /// <summary>
    /// Provides access to input actions defined in input action map "PlayerInputAction".
    /// </summary>
    public struct PlayerInputActionActions
    {
        ...
        /// <summary>
        /// Provides access to the underlying input action "PlayerInputAction/Move".
        /// </summary>
        public InputAction @Move => m_Wrapper.m_PlayerInputAction_Move;
        /// <summary>
        /// Provides access to the underlying input action "PlayerInputAction/Interact".
        /// </summary>
        ...
        /// <summary>
        /// Implicitly converts an <see ref="PlayerInputActionActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        ...
        /// </remarks>
        /// <seealso cref="PlayerInputActionActions" />
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="PlayerInputActionActions.UnregisterCallbacks(IPlayerInputActionActions)" />.
        /// </summary>
        /// <seealso cref="PlayerInputActionActions.UnregisterCallbacks(IPlayerInputActionActions)" />
        ...
        /// </remarks>
        /// <seealso cref="PlayerInputActionActions.AddCallbacks(IPlayerInputActionActions)" />
        /// <seealso cref="PlayerInputActionActions.RemoveCallbacks(IPlayerInputActionActions)" />
        /// <seealso cref="PlayerInputActionActions.UnregisterCallbacks(IPlayerInputActionActions)" />
    ...
    /// <summary>
    /// Provides a new <see cref="PlayerInputActionActions" /> instance referencing this action map.
    /// </summary>
    public PlayerInputActionActions @PlayerInputAction => new PlayerInputActionActions(this);
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "PlayerInputAction" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="PlayerInputActionActions.AddCallbacks(IPlayerInputActionActions)" />
    /// <seealso cref="PlayerInputActionActions.RemoveCallbacks(IPlayerInputActionActions)" />
